package com.ava.tfl.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.ava.tfl.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.ava.tfl.model" });
